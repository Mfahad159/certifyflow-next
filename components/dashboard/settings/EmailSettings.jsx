...
const EMAIL_PROVIDERS = [
  { 
    ...
    setupUrl: 'https://resend.com/docs/introduction',
    testEmail: 'onboarding@resend.dev',
    note: 'Use onboarding@resend.dev for testing without domain verification'
  },
  { 
    id: 'gmail', 
    name: 'Gmail (Nodemailer)', 
    placeholder: 'your-email@gmail.com:your-app-password',
    freeTier: '500 emails/day',
    setupUrl: 'https://support.google.com/accounts/answer/185833',
    note: 'Format: email:appPassword - Requires Gmail App Password',
    description: 'Enable 2-Step Verification then create an App Password in your Google Account settings'
  },
]

export default function EmailSettings() {
  const navigate = useRouter()
  const [emailProvider, setEmailProvider] = useState(() => localStorage.getItem('emailProvider') || 'resend')
  const [apiKey, setApiKey] = useState(() => localStorage.getItem('emailApiKey') || '')
  const [fromEmail, setFromEmail] = useState(() => localStorage.getItem('fromEmail') || '')
  const [fromName, setFromName] = useState(() => localStorage.getItem('fromName') || '')

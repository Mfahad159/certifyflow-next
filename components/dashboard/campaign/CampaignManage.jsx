        ...
        <div className="mb-10 flex flex-col md:flex-row items-center gap-6">
          ...
          <div className="flex items-center gap-2 bg-secondary/20 dark:bg-zinc-900/40 p-1.5 rounded-full border border-border backdrop-blur-md">
            <button
              ...
              className={`px-6 py-2.5 rounded-full text-[12px] font-bold transition-all ${
                filterStatus === 'all' 
                ...
                {filteredRecipients.map((recipient, idx) => (
                  ...
                  >
                    ...
                    <td className="py-6 px-6 text-center">
                      <div className={`inline-flex items-center px-3 py-1.5 rounded-full text-[8px] font-bold backdrop-blur-md ${
                    ...
                    <td className="py-6 px-10 text-right">
                      <button
                        ...
                        className={`w-9 h-9 rounded-full flex items-center justify-center transition-all cursor-pointer ml-auto ${
                          recipient.status === 'sent'

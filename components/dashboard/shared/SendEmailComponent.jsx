          ...
          <div className="w-full max-w-2xl bg-background/50 backdrop-blur-3xl border border-border rounded-[48px] overflow-hidden shadow-2xl shadow-accent/5">
            ...
            <div className="flex border-b border-border/50">
              {[
                ...
                <div
                  key={s.id}
                  className={`flex-1 flex items-center justify-center gap-2 py-5 text-[12px] font-bold border-b-2 transition-all ${step === s.id ? "border-accent text-accent bg-accent/5" : "border-transparent text-muted-foreground opacity-50"
                    }`}
                >
                  <s.icon size={14} />
                  {s.label}
                    ...
                    <div className="relative pt-1">
                      ...
                      <div className="overflow-hidden h-4 mb-4 text-xs flex rounded-full bg-secondary/40 border border-border/50 p-1">
                        <div
                          ...
                          className={`shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center rounded-full transition-all duration-500 ease-out ${isPaused ? "bg-zinc-400" : "bg-gradient-to-r from-accent to-[#4482ff]"
                            }`}
                        />
                      </div>
